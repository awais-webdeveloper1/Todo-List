...
export default function Nav(){
    return(
      ...
      <section className="fixed h-16 w-full flex justify-between items-center shadow-xl  bg-white text-black px-12">
        ...
        <Link href="/signup"> <div ><button className="bg-emerald-600 text-white border h-12 w-30 rounded-3xl shadow-xl cursor-pointer font-semibold">Sign Up</button></div></Link>
      </section>
